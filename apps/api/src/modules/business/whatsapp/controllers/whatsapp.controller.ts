...
export class WhatsappController {
  ...
  if (
    ...
    throw new BadRequestException(
      'Firma criptográfica x-hub-signature-256 ausente.',
    );
  }

    // Corregido: Mapeo asertivo explícito para la compatibilidad exacta exigida por el servicio
    ...
    this.whatsappService.validateSignature(payload, signature);
      ...
      if (rawPhoneNumber) {
        ...
        let restaurantCountryFallback: any = "ES";
      ...
      // 2. Encolar en Redis para procesamiento asíncrono pesado de fondo
